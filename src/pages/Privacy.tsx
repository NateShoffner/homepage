    ...
    <>
      ...
      <section className="page-section p-4 p-lg-5 d-flex d-column">
        <div className="my-auto">
          ...
          <p>
            This site uses "Google Analytics" to collect information about use
            of this site. Google Analytics collects information such as how
            often users visit this site, what pages they visit when they do so,
            and what other sites they used prior to coming to this site. This
            site uses use the information it gets from Google Analytics only to
            improve this site. Google Analytics collects only the IP address
            ...
            (as{" "}
            <a
              href="http://www.howto.gov/sites/default/files/google-analytics-tos-amendment.pdf"
              target="_blank"
            >
              amended for government websites
            </a>
            ) and the{" "}
            <a
              title="Link: http://www.google.com/privacypolicy.html"
          ...
          <p>
            Google Analytics employs cookies to define user sessions, which
            allows for the collection of data about how visitors are using the
            websites. Google Analytics uses only first-party cookies for data
            analysis. This means that the cookies are linked to a specific
            website domain, and Google Analytics will only use that cookie data
            for statistical analysis related to your browsing behavior on that
            specific website. According to Google, the data collected cannot be
            altered or retrieved by services from other domains.
          </p>

          <p>
            If you choose, you can opt out by turning off cookies in the
            preferences settings in your web browser. For more information on
